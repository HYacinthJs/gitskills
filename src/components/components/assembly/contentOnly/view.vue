                ...
                <template>
                   ...
                   <template  v-for="(item, index) in current.components.content">
                       <template  v-if="item.type!='ComponentsInputHidden'" >
                           <el-table-column :align="item.align" :key="index" :label="item.label" v-if="item.components&&item.components.content&&item.components.content.length>0">
                               <template v-for="(item2, index) in item.components.content">
                                   <template v-if="item2.type!='ComponentsInputHidden'" >
                                       <el-table-column :align="item2.align" :key="index" :label="item2.label" v-if="item2.components&&item2.components.content&&item2.components.content.length>0">
