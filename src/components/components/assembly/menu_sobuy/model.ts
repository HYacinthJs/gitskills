...
export class AssemblyMenu_sobuy extends Layout {
    ...
    set isCollapse(isCollapse: boolean) {
        ...
        let normal = utils.getPage().getComponents({system_id:"normal"})
        console.log(normal.aside_width)
        if(normal.aside_width == "240px"){
            normal.aside_width = "66px"
        }else {
            normal.aside_width = "240px"
        }
