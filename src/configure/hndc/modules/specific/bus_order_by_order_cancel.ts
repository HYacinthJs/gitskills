    ...
    components:[
        ...
        },
        {
            modelName:'content',type: 'AssemblyContent', components:[
                ...
                {modelName:'content',name: 'no', label: '订单号',type:'ComponentsInput',width: 170},
                {modelName:'content',name: 'create_time', label: '订单时间',type:'ComponentsInput',width: 170},
                {modelName:'content',name: 'price_all', label: '订单总价(元)',type:'ComponentsInput'},
                {modelName:'content',name: 'price_del', label: '订单优惠金额(元)',type:'ComponentsInput',},
                {modelName:'content',name: 'price_rea', label: '订单优惠后价格(元)',type:'ComponentsInput',},
                {modelName:'content',name: 'price_back', label: '退款金额(元)',type:'ComponentsInput',},
                {modelName:'content',name: 'is_back', label: '是否退款',type:'ComponentsInput',},
