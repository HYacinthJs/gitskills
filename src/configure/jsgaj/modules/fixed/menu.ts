...
const myModule:{ [key: string]: any} = {
    ...
    components:[
        {
            modelName:'content',type: 'AssemblyContentOnly',primaryKey : 'menu_id',
            components:[
        ...
        {modelName:'dialog',name:"edit",type: 'DialogEdit',jurisdictionJson: [{jurisdiction: [{name: "edit"},{name: "add"}]},],components:[
                {modelName:'from',type: 'AssemblyFrom',components:[
                        {modelName:'content',name:"menu_level",label:"等级",type: 'ComponentsInputSelect',disabledJson: [{system_id: [{system_menu_id: 0}]},],system_id:'system_menu_level',options:[{value:'主页面',label:'主页面'},{value:'子页面',label:'子页面'}]},
                        ...
                        {modelName:'content',name: "menu_id", label: 'id',type:'ComponentsInputHidden',system_id:'system_menu_id',value_default:0},
                    ]},
