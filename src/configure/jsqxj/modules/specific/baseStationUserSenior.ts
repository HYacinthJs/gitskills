...
const myModule:{ [key: string]: any} = {
    ...
    version:'PageNormal',
    api:{
        delete:"/baseStationUserSenior/delete",
        save:"/baseStationUserSenior/save",
        queryById:"/baseStationUserSenior/queryById",
        query:"/baseStationUserSenior/query",
        import:"/baseStationUserSenior/saveAll"
    },
    components:[
        {
            ...
            components:[
                {modelName:'query',type: 'AssemblyFrom',components:[
                        ...
                        {modelName:'content',type: 'ComponentsInputImport',dialogName:"import",import_name:"导入用户",
