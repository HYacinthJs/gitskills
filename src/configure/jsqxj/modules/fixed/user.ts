...
const myModule:{ [key: string]: any} = {
    ...
    components:[
        ...
        },
        {
            ...
            components:[
                {modelName:'content',name:"company_name",label:"公司",type: 'ComponentsInput'},
        ...
        {modelName:'dialog',name:"edit",type: 'DialogEdit',components:[
                {modelName:'from',type: 'AssemblyFrom',components:[
                        {modelName:'content',name:"company_id",label:"公司",type: 'ComponentsInputSelect',rules:[{validator: utils.my_required, message: "请选择公司"}],ajax_url:"getCompany",props_label:"name",props_value:"id",system_id:"system_company_id",associated_notice:["system_p_id"]},
                        {modelName:'content',name:"department_id",label:"部门",type: 'ComponentsInputCascader',rules:[{validator: utils.my_required, message: "请选择部门"}],ajax_url:"getTree",system_id:"system_p_id",ajax_params:[{type:"control",name:"company_id",system_id:"system_company_id"}]},
                        {modelName:'content',name:"r_id",label:"角色",type: 'ComponentsInputSelect',system_id:"system_role",
                            rules:[{validator: utils.my_required, message: "请选择角色"}],ajax_url:"role",props_label:"r_name",props_value:"r_id"},
                        ...
                        {modelName:'content',name:"ui_telno",label:"联系方式",type: 'ComponentsInput',rules:[{validator: utils.my_required, message: "请输入帐号"}]},
                        {modelName:'content',name:"ui_code",label:"账号",type: 'ComponentsInput',rules:[{validator: utils.my_required, message: "请输入联系方式"}]},
