    ...
    components:[
        ...
        },
        {
            modelName:'content',type: 'AssemblyContent', components:[
                ...
                {modelName:'content',name: 'goods_id', label: '物品名称',type:'ComponentsInput'},
                {modelName:'content',name: 'price', label: '物品原价',type:'ComponentsInput'},
                {modelName:'content',name: 'is_dis', label: '是否折扣',type:'ComponentsInput'},
