...
const myModule:{ [key: string]: any} = {
    type:'normal',
    name:'sys_bus_menu_lunch_no_reserve',
    version:'PageNormal',
    requiresAuth:false,
    api:{
        query: "/bus_menu/queryByLunchNoReserve",
        queryByAll: "/bus_menu/queryByAll",
        queryById:  "/bus_menu/queryById",
        save:  "/bus_menu/save",
        delete:  "/bus_menu/delete",
        queryByAll3:  "/bus_food/queryByAll3",
    },
    components:[
        {
        ...
        {modelName:'dialog',name:"edit",type: 'DialogEdit',components:[
                {modelName:'from',type: 'AssemblyFrom',components:[
                        ...
                        {modelName:'content',name: "breakfast", label: "现场午餐",filterable:true, type: "ComponentsInputTransfer",ajax_url:"queryByAll3",props_label:"name",props_value:"id"},
                        ...
                        {modelName:'content',name: 'type', label: '菜单类型',type:'ComponentsInputHidden',value_default:'现场午餐'},
