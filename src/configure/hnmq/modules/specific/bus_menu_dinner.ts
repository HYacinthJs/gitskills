...
const myModule:{ [key: string]: any} = {
    type:'normal',
    name:'sys_bus_menu_dinner',
    version:'PageNormal',
    requiresAuth:false,
    api:{
        query: "/bus_menu/queryByDinner",
        queryByAll: "/bus_menu/queryByAll",
        queryById:  "/bus_menu/queryById",
        save:  "/bus_menu/save",
        delete:  "/bus_menu/delete",
        queryByDinner:  "/bus_setmeal/queryByDinner",
    },
    components:[
        {
        ...
        {modelName:'dialog',name:"edit",type: 'DialogEdit',components:[
                {modelName:'from',type: 'AssemblyFrom',components:[
                        ...
                        {modelName:'content',name: "breakfast", label: "晚餐",filterable:true, type: "ComponentsInputTransfer",ajax_url:"queryByDinner",props_label:"name",props_value:"id" },
                        ...
                        {modelName:'content',name: 'type', label: '菜单类型',type:'ComponentsInputHidden',value_default:'晚餐'},
