    ...
    components:[
        ...
        {modelName:'dialog',name:"edit",type: 'DialogEdit',components:[
                {modelName:'from',type: 'AssemblyFrom',components:[
                        {modelName:'content',name:"r_id",label:"角色",type: 'ComponentsInputSelect',ajax_url:"role",props_label:"r_name",props_value:"r_id",rules:[{ validator: utils.my_required, message: '请选择角色' }]},
                        {modelName:'content',name:"ui_name",label:"用户名",type: 'ComponentsInput',rules:[{ validator: utils.my_required, message: '请输入用户名' }]},
                        {modelName:'content',name:"department_id",label:"部门",type: 'ComponentsInputCascader',ajax_url:"department",jurisdictionJson: [{user:[{ui_name:'系统管理员'}]}]},
                        {modelName:'content',name:"area_id",label:"所属地区",type: 'ComponentsInputCascader',ajax_url:"area",jurisdictionJson: [{user:[{ui_name:'系统管理员2'}]}]},
