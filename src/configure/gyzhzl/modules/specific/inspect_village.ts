    ...
    components:[
        {
            modelName:'content', type: 'AssemblyQuery',components:[
                {modelName:'query',type: 'AssemblyFrom',components:[
                        ...
                        {modelName:'content',name:"type",value_default:'村自查',type: 'ComponentsInputHidden'},
        ...
        },
        {
            ...
            tableBtn : [
                {label:"整改",show:true,click:function(data:any){
                        ...
                        edit.query()
                    }, jurisdictionJson: [{row: [{process:'待整改'}]}]
                },
                ...
                {modelName:'from',type: 'AssemblyFrom',components:[
                        {modelName:'content',name:"area",label:"所属地区",type: 'ComponentsInputSelect',rules:[{ validator: utils.my_required, message: '请选择所属地区' }],ajax_url:"queryByGY",props_label:"name",props_value:"id",
                            initValue() {
                                ...
                                if(utils.isNotNull(user)&&utils.isNotNull(user.area_id)){
                                    that.value = user.area_id
                                }else{
