    ...
    components:[
        ...
        },
        {
            modelName:'content',type: 'AssemblyContent', components:[
                ...
                {modelName:'content',name:"myd",label:"步骤2",type: 'ComponentsInput'},
        ...
        {modelName:'dialog',name:"edit",dialog_width:"970px",type: 'DialogEdit',components:[
                {modelName:'from',type: 'AssemblyFrom',components:[
                        ...
                        {modelName:'content',name:"kind",label:"主要类型",type: 'ComponentsInputSelect',rules:[{ validator: utils.my_required, message: '请选择主要类型' }],ajax_url:"dict",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"code",value:"三改一拆"}]},
                        {modelName:'content',name:"kind1",label:"次要类型",type: 'ComponentsInputSelect',ajax_url:"dict",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"code",value:"三改一拆"}]},
                        {modelName:'content',name:"kind2",label:"次要类型",type: 'ComponentsInputSelect',ajax_url:"dict",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"code",value:"三改一拆"}]},
                        {modelName:'content',name:"department_id",label:"主要责任部门",label_width:'110px',type: 'ComponentsInputSelect',rules:[{ validator: utils.my_required, message: '请选择主要责任部门' }],ajax_url:"department",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"type",value:"三改一拆"}]},
                        {modelName:'content',name:"department_id2",label:"次要责任部门",type: 'ComponentsInputSelectMultiple',ajax_url:"department",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"type",value:"三改一拆"}]},
        ...
        {modelName:'dialog',name:"info",dialog_width:"970px",title:"详情",type: 'DialogEdit',components:[
                {modelName:'from',type: 'AssemblyFrom',components:[
                        ...
                        {modelName:'content',name:"list",label:"记录",type: 'ComponentsInputTable',addBtn:false,editTr:false,style:{width: "930px"},label_show: false,value_default:[],components:[
                                ...
                                // {modelName:'template',name:"plan",label:"计划",type: 'ComponentsText',style:{width: "auto"}},
