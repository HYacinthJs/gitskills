...
const myModule:{ [key: string]: any} = {
    type:'normal',
    name:'sys_report_water_csl',
    version:'PageNormal',
    api:{
        query: "/reportWaterCsl/query",
        queryByAll: "/reportWaterCsl/queryByAll",
        queryById:  "/reportWaterCsl/queryById",
        save:  "/reportWaterCsl/save",
        delete:  "/reportWaterCsl/delete",
    },
    components:[
        {
