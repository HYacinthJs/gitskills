...
const myModule:{ [key: string]: any} = {
    type:'normal',
    name:'sys_report_demolition_csl',
    version:'PageNormal',
    api:{
        query: "/reportDemolitionCsl/query",
        queryByAll: "/reportDemolitionCsl/queryByAll",
        queryById:  "/reportDemolitionCsl/queryById",
        save:  "/reportDemolitionCsl/save",
        delete:  "/reportDemolitionCsl/delete",
    },
    components:[
        {
