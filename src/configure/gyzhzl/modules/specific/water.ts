...
const myModule:{ [key: string]: any} = {
    ...
    api:{
        query: "/water/query",
        queryByAll: "/water/queryByAll",
        queryById:  "/water/queryById",
        save:  "/water/save",
        delete:  "/water/delete",
        dict:  "/dict/queryByAll",
        updateUpload:  "/water/updateUpload",
        updateExamine:  "/water/updateExamine",
        updateIssued:  "/water/updateIssued",
        updateRectification:  "/water/updateRectification",
        updateReexamineOk:  "/water/updateReexamineOk",
        updateReexamineErr:  "/water/updateReexamineErr",
        updateDelay:  "/water/updateDelay",
    ...
    components:[
        {
            modelName:'content', type: 'AssemblyQuery',components:[
                {modelName:'query',type: 'AssemblyFrom',components:[
                        ...
                        {modelName:'content',name:"kind",label:"类型代码",type: 'ComponentsInputSelect',ajax_url:"dict",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"code",value:"水环境管理"}]},
        ...
        {modelName:'dialog',name:"edit",dialog_width:"970px",type: 'DialogEdit',components:[
                {modelName:'from',type: 'AssemblyFrom',components:[
                        ...
                        {modelName:'content',name:"kind",label:"主要类型",type: 'ComponentsInputSelect',rules:[{ validator: utils.my_required, message: '请选择主要类型' }],ajax_url:"dict",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"code",value:"水环境管理"}]},
                        {modelName:'content',name:"kind1",label:"次要类型",type: 'ComponentsInputSelect',ajax_url:"dict",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"code",value:"水环境管理"}]},
                        {modelName:'content',name:"kind2",label:"次要类型",type: 'ComponentsInputSelect',ajax_url:"dict",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"code",value:"水环境管理"}]},
                        {modelName:'content',name:"department_id",label:"主要责任部门",label_width:'110px',type: 'ComponentsInputSelect',rules:[{ validator: utils.my_required, message: '请选择主要责任部门' }],ajax_url:"department",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"type",value:"水环境管理"}]},
                        {modelName:'content',name:"department_id2",label:"次要责任部门",type: 'ComponentsInputSelectMultiple',ajax_url:"department",props_label:"name",props_value:"id",ajax_params:[{type:"text",name:"type",value:"水环境管理"}]},
        ...
        {modelName:'dialog',name:"updateUpload",apiName_save:"updateUpload",dialog_width:"970px",title:"上报",type: 'DialogEdit',components:[
                {modelName:'from',type: 'AssemblyFrom',components:[
                        ...
                        {modelName:'content',name:"kind_name1",label:"次要类型",type: 'ComponentsText'},
                        {modelName:'content',name:"kind_name2",label:"次要类型",type: 'ComponentsText'},
                        {modelName:'content',name:"remark",label:"问题描述",type: 'ComponentsText'},
                        {modelName:'content',name:"photo",label:"问题照片",type: 'ComponentsInputImage',style:{width: "730px"}},
                        {modelName:'content',name: 'id', label: 'id',type:'ComponentsInputHidden'},
                    ]},
            ],toolBtn : [
